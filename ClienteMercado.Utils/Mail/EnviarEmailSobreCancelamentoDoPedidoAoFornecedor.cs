...
namespace ClienteMercado.Utils.Mail
{
    ...
    {
        public bool EnviarEmail(string _nomeCC, string _usuarioAdmCC, string _foneUsuarioAdmCC, string _dataEnvioPedido, string _numeroPedido, 
            string _motivoDesistenciaDoPedido, string _empresaFornecedora, string _nomeContatoEmpresaFornecedora, string _email1_EmpresaForn, 
            string _email2_EmpresaForn, string _email1_UsuarioContatoEmpresaForn, string _email2_UsuarioContatoEmpresaForn)
        {
