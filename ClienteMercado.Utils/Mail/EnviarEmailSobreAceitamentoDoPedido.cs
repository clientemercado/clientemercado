...
namespace ClienteMercado.Utils.Mail
{
    public class EnviarEmailSobreAceitamentoDoPedido
    {
        ...
        public bool EnviarEmail(string _nomeCC, string _usuarioAdmCC, string _empresaFornecedora, string _email1_EmpresaAdmCC, string _email2_EmpresaAdmCC,
            string _email1_UsuarioContatoAdmCC, string _email2_UsuarioContatoAdmCC, string _dataEnvioPedido, string _numeroPedido, string _dataEntrega, string _tipoFrete, 
            string _usuarioConfirmou, string _foneUsuarioConfirmou)
        {
            ...
            mensagem = @"<html>" +
                        ...
                        "&nbsp;&nbsp;O Fornecedor <b>" + _empresaFornecedora + "</b>, ACEITOU o PEDIDO, efetuado por sua Central de Compras no dia " + _dataEnvioPedido + "." + 
                        "</td>" +
                        "</tr>" + 
                        "<br><br>" +
