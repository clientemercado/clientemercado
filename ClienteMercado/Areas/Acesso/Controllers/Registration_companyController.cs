    ...
    public class Registration_companyController : Controller
    {
        ...
        public ActionResult CadastroBasicoDaEmpresa(string cnpj, string razaoSocial, string nomeUsuario, string email1, string login, string passw, string pais)
        {
            try
            {
                ...
                NPaisesService negociosPaises = new NPaisesService();
                empresa_usuario dadosDaEmpresa = new empresa_usuario();

                //BUSCAR CÓD. do PAÍS
                paises_empresa_usuario dadosPais = negociosPaises.BuscarCodigoDoPaisPeloNomeDoPais(pais);
                ...
                usuarioADMNovaEmpresa.ID_CODIGO_ENDERECO_EMPRESA_USUARIO = 1;
                usuarioADMNovaEmpresa.ID_CODIGO_PROFISSAO = 1;
                usuarioADMNovaEmpresa.TELEFONE1_USUARIO_EMPRESA = "(27)99269-1260";
                ...
                dadosDaEmpresa.ID_CODIGO_ENDERECO_EMPRESA_USUARIO = 1;
                dadosDaEmpresa.EMAIL1_EMPRESA = email1;
                dadosDaEmpresa.TELEFONE1_EMPRESA_USUARIO = "(27)99269-1260";
                ...
                dadosDaEmpresa.ID_GRUPO_ATIVIDADES = 54;
                ...
                {
                    empresa_usuario empresaUsuario = negociosEmpresaUsuario.GravarEmpresaUsuario(dadosDaEmpresa);
