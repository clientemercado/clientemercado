$(document).ready(function () {
    ...
    $("#btn-gravar").click(function (e) {
        ...
        if (qtdCamposVazios == 0) {
            ...
            $.ajax({
                type: "POST",
                url: "/UsuarioEmpresaCliente/GravarRegistro",
                traditional: true,
                async: false,
                dataType: "json",
    ...
    $("#btn-alterar").click(function (e) {
        ...
        if (qtdCamposVazios == 0) {
            ...
            $.ajax({
                type: "POST",
                url: "/UsuarioEmpresaCliente/AtualizarRegistro",
                traditional: true,
                async: false,
                dataType: "json",
                contentType: "application/json",
