$(document).ready(function () {
    ...
    $("#btn-gravar").click(function (e) {
        ...
        if (qtdCamposVazios == 0) {
            ...
            //Obtendo o valores
            obj['descricao_SubDepartamentoEmpresaCliente'] = $("#inNomeSubDepto").val();
            obj['id_DepartamentoEmpresaCliente'] = $("#inListaDepartamentos").val();
            //obj['ativoInativo_DepartamentoEmpresaCliente'] = $("#inValidade").val();

            $.ajax({
                type: "POST",
                url: "/SubDepartamentosEmpresa/GravarRegistro",
                traditional: true,
                async: false,
                dataType: "json",
                ...
                success: function (data) {
                    ...
                    if (data.status == "ok") {
                        ...
                        window.location.href = "/Company/SubDepartamentosEmpresa/AlterarDados?id=" + idRegistroGerado;
                    }
                    else {
    ...
    $("#btn-alterar").click(function (e) {
        ...
        if (qtdCamposVazios == 0) {
            ...
            $.ajax({
                type: "POST",
                url: "/SubDepartamentosEmpresa/AtualizarRegistro",
                traditional: true,
                async: false,
                dataType: "json",
                contentType: "application/json",
