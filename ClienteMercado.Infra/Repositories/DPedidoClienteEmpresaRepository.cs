...
namespace ClienteMercado.Infra.Repositories
{
    public class DPedidoClienteEmpresaRepository : RepositoryBase<PedidoCliente_EmpresaCliente>
    {
        ...
        public List<ListaItensDoPedidoViewModel> BuscarListaDeProdutosDoPedido(int idPedido)
        {
            try
            {
                var query = "SELECT PP. SELECT P.descricao_ProdutoEmpresaCliente AS itemPedido, PP.quantidade_ProdutosPedidoCliente, " +       
                            "PP.valorUnitario_ProdutosPedidoCliente, PP.dataEntregaItemPedido_ProdutosPedidoCliente, " + 
